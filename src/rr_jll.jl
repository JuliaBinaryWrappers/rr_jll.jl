...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import rr_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("e86bdf43-55f7-5ea2-9fd0-e7daa2c0f2b4"))
platforms = [Pkg.Artifacts.unpack_platform(e, "rr", artifacts_toml) for e in artifacts["rr"]]
...
if best_platform === nothing
    @debug("Unable to load rr; unsupported platform $(triplet(platform_key_abi()))")
else
